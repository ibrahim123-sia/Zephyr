...
router.post("/", async (req, res) => {
  const { productId, quantity, volume, concentration, guestId, userId } = req.body;
...
router.delete("/", async (req, res) => {
  const { productId, volume, concentration, guestId, userId } = req.body;
        ...
        guestCart.products.forEach((guestItem) => {
          const productIndex = userCart.products.findIndex(
            (item) =>
              ...
              item.volume === guestItem.volume &&
              item.concentration === guestItem.concentration
          );
